...
- **Mobile First Compact 2-Column Desktop-Style View (Zero Horizontal Scroll)**:
  - **Desktop (>1024px)**: แสดงผลแบบ 2 คอลัมน์คู่ขนาน (ซ้าย: ฟอร์มคำนวณและประวัติ, ขวา: ผลวิเคราะห์และแอนิเมชัน)
  - **Mobile (≤1024px)**: ปรับแสดงผลแบบ **2 คอลัมน์คู่ขนานเหมือนบนคอมพิวเตอร์ (Desktop-Parity)** โดยแบ่งสัดส่วน คอลัมน์ซ้าย 42% (ฟอร์มสั่งคำนวณ + ประวัติย้อนหลัง) และคอลัมน์ขวา 58% (ผลรางวัล 6D VIP + แอนิเมชัน) ย่อสเกลฟอนต์และช่องไฟให้พอดีกับความกว้างหน้าจอมือถือ (Zero Horizontal Scroll 100%) ผู้ใช้ไม่ต้องเลื่อนจอไปทางขวาเพื่อดูผลลัพธ์
